...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Verificar Usuarios");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 17, 20, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Buscar:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(516, 112, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(595, 109, 300, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Email", "N° de telefono", "Dirección", "Pregunta de seguridad", "Estado"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 153, 1153, 508));

        jLabel3.setFont(new java.awt.Font("Bahnschrift", 0, 24)); // NOI18N
        jLabel3.setText("* Haga clic en la fila para cambiar el estado");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(455, 695, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fondo_grande.png"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(status.equals("true"))
            ...
            status = "true";
        int a = JOptionPane.showConfirmDialog(null, "¿Desea cambiar el estado de "+email+"?","Seleccione",JOptionPane.YES_NO_OPTION);
        if(a==0) {
